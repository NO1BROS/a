            ...
            [
                [
                    InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 ›", url=f"https://t.me/VVHH9"),
                ],
            ]
        ),
    )
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""◉ 𝙽𝙰𝙼𝙴 : ❪ [𓏺 ժᥱ᥎ ꪀᥲ️ժᥱᖇ . 🕷 ˼](https://t.me/N_1_F)  ❫
◉ 𝚄𝚂𝙴𝚁 : ❪ @N_1_F ❫
◉ 𝙸𝙳   : ❪ 5676384368 ❫
◉ 𝙱𝙸𝙾  : ❪ انا كبير في عين نفسي. انما عينك انتا تع احطلك فيها قطره. @VVHH9 ❫ """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ ›", url=f"https://t.me/N_1_F"),
                ],[
                InlineKeyboardButton(
                        "‹ ᥉᥆υᖇᥴᥱ ᥲ️ᖇꪀ᥆ρ . 🐰 › ", url=f"https://t.me/VVHH9"), 
                ]
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼""",
        ...
        [
            [
                    InlineKeyboardButton(
                        "‹ ժᥱ᥎ ꪀᥲ️ժᥱᖇ . 🕷 › ", url=f"https://t.me/N_1_F"),
                ],[
                    InlineKeyboardButton(
                        "‹ ᥴ𝗁ᥲ️ꪀꪀᥱᥣ›", url=f"https://t.me/VVHH9"), 
                    InlineKeyboardButton(
                        "‹ ᥉υρρ᥆ᖇƚ›", url=f"https://t.me/ZVZV4"),
                ],[
                    InlineKeyboardButton(
                        "‹ اضف البوت لمجموعتك ›", url=f"https://t.me/K0HBOT?startgroup=true"),
            ]
        ]
         ),
     )
